    ...
    return (
        ...
        >
            ...
            <div className="px-4 sm:px-8 lg:px-20 py-2 flex items-center justify-between relative">
                ...
                <div
                    className={`lg:hidden md:hidden absolute top-full left-0 w-full bg-black/80 backdrop-blur-sm flex flex-col items-center gap-6 py-12 transition-all duration-300 ease-in-out ${menuOpen
